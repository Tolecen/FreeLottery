...
typedef enum _ASINetworkReqestType
{
    ...
    ASINetworkRequestTypeselectUserNo,
    ASINetworkRequestTypeThirdLoginRegister,
    ASINetworkRequestTypeThirdLoginBind,
    ...
    ASINetworkRequestTypeQueryShakeActList,
    ASINetworkRequestTypeDoShakeCheck,
    ASINetworkRequestTypeQueryShakeSignInDescription,
    ...
    ASINetworkRequestTypeUpdateInformation,
    ...
    ASINetworkRequestTypeQueryADInformation,
    ...
    ASINetworkRequestTypeUmpayCreDit,
    ASINetworkRequestTypeWealthTenpay,
    ...
    ASINetworkRequestTypeWinningInformationMaxresult,
    ASINetworkRequestTypeAllLeftTime,
    ASINetworkRequestTypeTicketPropaganda,
	ASINetworkRequestTypeCancelTrack,
	ASINetworkRequestTypeLaunchLot,
    ASINetworkRequestTypeGETShareDetile,
    ...
    ASINetworkReqestTypeBindEmailSecurity,
    ASINetworkReqestTypeBindPhone,
    ASINetworkReqestTypeCancelBindPhone,
    ASINetworkReqestTypeCancelBindEmail,
    ASINetworkRequestTypeFindPsw,
    ASINetworkRequestTypeGetInformationOfCaiMinZhuanQu,
    ASINetworkRequestTypeGetInformationOfZhuanJiaTuiJian,
    ASINetworkRequestTypeGetInformationOfZuCaiTianDi,
    ASINetworkRequestTypeGetInformationOfZhanNeiGongGao,
    ...
    ASINetworkReqestTypeGetAwardInfoDetail,
    ...
    ASINetworkRequestTypeGetZCmain,
    ...
    ASINetworkReqestTypeMorePageOfGNZY,
    ASINetworkReqestTypeMorePageOfCPWF,
    ASINetworkReqestTypeMorePageOfCJWT,
    ASINetworkReqestTypeMorePageOfCPSY,
    ...
    ASINetworkRequestTypeSSQ,
    ASINetworkRequestTypeDLT,
    ASINetworkRequestTypeFC3D,
    ASINetworkRequestType11YDJ,
    ASINetworkRequestType115,
    ASINetworkRequestTypeSSC,
    ASINetworkRequestTypeKLSF,
    ASINetworkRequestTypeCQSF,
    ASINetworkRequestTypeNMKS,
    ASINetworkRequestTypeCQ115,
    ASINetworkRequestTypeGD115,
    ASINetworkRequestTypeQLC,
    ASINetworkRequestTypePLS,
    ASINetworkRequestTypePLW,
    ASINetworkRequestTypeQXC,
    ASINetworkRequestType22X5,
    ASINetworkRequestTypeZC,
    ASINetworkRequestTypeRecentlyEvent,
