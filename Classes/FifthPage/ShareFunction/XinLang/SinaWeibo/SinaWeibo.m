...
{
    return [self initWithAppKey:_appKey appSecret:_appSecrect appRedirectURI:_appRedirectURI ssoCallbackScheme:[[CommonRecordStatus commonRecordStatusManager] getAppScheme:KAppScheme_Sina] andDelegate:_delegate];
}
