...
//        backGroundBtn.frame = [[UIScreen mainScreen] bounds];
//        [backGroundBtn addTarget:self action:@selector(backGroundAction:) forControlEvents:UIControlEventTouchUpInside];
