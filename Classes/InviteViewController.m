...
- (void)viewDidLoad
{
    ...
    self.inviteAwardL = [[UILabel alloc]initWithFrame:CGRectMake(10, 140, 310,30)];
    _inviteAwardL.numberOfLines = 0;
    ...
    UILabel * label4 = [[UILabel alloc]initWithFrame:CGRectMake(10, 180, 310,20)];
    [scrollView addSubview:label4];
    label4.textColor = [UIColor grayColor];
    label4.font = [UIFont systemFontOfSize:15];
    label4.text = @"Boss模式奖励";
    
    UIImageView * image2 = [[UIImageView alloc]initWithFrame:CGRectMake(110, 182, 18, 18)];
    image2.image = [UIImage imageNamed:@"BOSS"];
    [scrollView addSubview:image2];
    
    UIButton * bossB = [UIButton buttonWithType:UIButtonTypeCustom];
    bossB.frame = CGRectMake(10, 175, 140, 30);
    ...
    self.progressImg= [[UIImageView alloc]initWithFrame:CGRectMake(10, 210, 293.5, 31)];
    _progressImg.image = [UIImage imageNamed:@"jindudi"];
    [scrollView addSubview:_progressImg];
    
    self.percentL = [[UILabel alloc]initWithFrame:CGRectMake(10, 215, 100,20)];
    ...
    UILabel * label3 = [[UILabel alloc]initWithFrame:CGRectMake(10, 250, 20, 20)];
    [scrollView addSubview:label3];
    label3.textColor = [UIColor grayColor];
    label3.font = [UIFont systemFontOfSize:15];
    label3.tag = 10;
    UILabel * label5 = [[UILabel alloc]initWithFrame:CGRectMake(100, 250, 20, 20)];
    [scrollView addSubview:label5];
    label5.textColor = [UIColor grayColor];
    label5.font = [UIFont systemFontOfSize:15];
    label5.tag = 11;
    UILabel * label7 = [[UILabel alloc]initWithFrame:CGRectMake(200, 250, 20, 20)];
    [scrollView addSubview:label7];
    label7.textColor = [UIColor grayColor];
    label7.font = [UIFont systemFontOfSize:15];
    label7.tag = 12;
    
    UIImageView * image4 = [[UIImageView alloc]initWithFrame:CGRectMake(10, 280, 18, 18)];
    image4.image = [UIImage imageNamed:@"shouyaoqing"];
    [scrollView addSubview:image4];
    
    UILabel * label6 = [[UILabel alloc]initWithFrame:CGRectMake(40, 280, 100, 20)];
    [scrollView addSubview:label6];
    label6.text = @"受邀人奖励";
    
    self.invitedAwardL = [[UILabel alloc]initWithFrame:CGRectMake(10, 310, 310,20)];
    ...
    UIView * view2 = [[UIView alloc]initWithFrame:CGRectMake(0, 340, self.view.frame.size.width, 170)];
    view2.backgroundColor = [ColorUtils parseColorFromRGB:@"#efede9"];
    [scrollView addSubview:view2];
    
    UIImageView * image5 = [[UIImageView alloc]initWithFrame:CGRectMake(10, 350, 18, 18)];
    image5.image = [UIImage imageNamed:@"liucheng"];
    [scrollView addSubview:image5];
    
    UILabel * label8 = [[UILabel alloc]initWithFrame:CGRectMake(40, 350, 100, 20)];
    [scrollView addSubview:label8];
    label8.backgroundColor = [UIColor clearColor];
    label8.text = @"推广流程";
    
    UIImageView * image6 = [[UIImageView alloc]initWithFrame:CGRectMake(15, 380, 288, 89)];
    image6.image = [UIImage imageNamed:@"liuchengtu"];
    [scrollView addSubview:image6];
    
    UILabel * label9 = [[UILabel alloc]initWithFrame:CGRectMake(10, 480, 310,20)];
    ...
    UIImageView * image7 = [[UIImageView alloc]initWithFrame:CGRectMake(10, 520, 18, 18)];
    image7.image = [UIImage imageNamed:@"tuguang"];
    [scrollView addSubview:image7];
    
    UILabel * label10 = [[UILabel alloc]initWithFrame:CGRectMake(40, 520, 100, 20)];
    [scrollView addSubview:label10];
    label10.text = @"推广方式";
    
    UIButton * shareB = [UIButton buttonWithType:UIButtonTypeCustom];
    shareB.frame = CGRectMake(15, 550, 291, 38);
    ...
    addressB.frame = CGRectMake(15, 600, 291, 38);
    ...
    twoDimensionB.frame = CGRectMake(15, 650, 291, 38);
