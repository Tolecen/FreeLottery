...
@interface PkSScLotteryAwardInfoVC : UIViewController <UITableViewDelegate, UITableViewDataSource,UIActionSheetDelegate,TextViewControllerDelegate,WXApiDelegate,MFMessageComposeViewControllerDelegate,sendMsgToWeChatViewDelegate,RespForWeChatViewDelegate>
{
