...
- (void)viewDidLoad
{
    ...
    m_newPswTextField2.placeholder = @"绑定的手机号";
...
- (void)submitChangeClick:(id)sender
{
    ...
    if(m_newPswTextField2.text.length != 11)
    {
        [[RuYiCaiNetworkManager sharedManager] showMessage:@"有效手机号码为11位！" withTitle:@"提示" buttonTitle:@"确定"];
        return;
    }
    
    [[RuYiCaiNetworkManager sharedManager] getBindPhoneSecurityCode:m_newPswTextField2.text];
}
