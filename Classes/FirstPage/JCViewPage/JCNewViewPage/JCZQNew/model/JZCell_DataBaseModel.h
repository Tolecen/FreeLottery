...
@interface JZCell_DataBaseModel : NSObject

@end

@interface JZTableViewCell_DataBase : NSObject {
    NSString                                *m_dayTime;
    ...
    //让球胜负平
    BOOL                                    m_RQZQ_S_ButtonIsSelect;
    BOOL                                    m_RQZQ_P_ButtonIsSelect;
    BOOL                                    m_RQZQ_F_ButtonIsSelect;
    //总进球数
...
@property (nonatomic,assign) BOOL RQZQ_S_ButtonIsSelect;
@property (nonatomic,assign) BOOL RQZQ_P_ButtonIsSelect;
@property (nonatomic,assign) BOOL RQZQ_F_ButtonIsSelect;
...
@interface JZTableViewCell_DataArray : NSObject {
