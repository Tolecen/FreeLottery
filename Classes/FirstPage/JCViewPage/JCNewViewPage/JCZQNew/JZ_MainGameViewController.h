...
@class CombineBase;
@class JZTableViewCell_DataBase;
@class DrawerView;

@interface JZ_MainGameViewController :
UIViewController <UITableViewDelegate,UITableViewDataSource, UIAlertViewDelegate,TopAnimationViewDelegate>
{
    ...
    JZTableViewCell_DataBase *base_one;
    JZTableViewCell_DataBase *base_two;
    ...
    /*
     ...
     玩法切换独立出来
     */
    TopAnimationView                     *m_playChooseView;
    //    UIImageView*                                iamge;
