//
//  JC_LaunchHMViewController_copy.m
//  RuYiCai
//
...
@interface JC_LaunchHMViewController_copy (internal)
...
@implementation JC_LaunchHMViewController_copy
...
- (void)viewDidLoad
{
    ...
    self.sliderBeishu.maximumValue = 46;
    self.sliderBeishu.minimumValue = 1;
    self.sliderBeishu.value = 1;
	...
	m_getNum = 10;
    m_getButton = [[UIButton alloc] initWithFrame:CGRectMake(95, /*453 - 26*/200, 67, 28)];
    ...
    m_yesSave = [[UIButton alloc] initWithFrame:CGRectMake(95, /*418 - 26*/162, 20, 20)];
    ...
    m_buttonOne = [[UIButton alloc] initWithFrame:CGRectMake(95, /*497 -26*/244, 50, 20)];
    ...
    m_buttonTwo = [[UIButton alloc] initWithFrame:CGRectMake(95,/* 524 -26*/271, 50, 20)];
    ...
    m_buttonThere = [[UIButton alloc] initWithFrame:CGRectMake(95, /*549 -26*/296 , 50, 20)];
    ...
    m_buttonFore = [[UIButton alloc] initWithFrame:CGRectMake(95, /*576 -26*/323, 50, 20)];
    ...
    m_buttonFive = [[UIButton alloc] initWithFrame:CGRectMake(95, /*601 -26*/348, 50, 20)];
...
- (void)refreshTopView
{
    ...
    int numBeishu = self.sliderBeishu.value;
//    if (numBeishu>0 && numBeishu<=10)
//    {
//        self.fieldBeishu.text = [NSString stringWithFormat:@"%d",numBeishu];
//    }else if(numBeishu>10 && numBeishu<=19)
//    {
//        self.fieldBeishu.text = [NSString stringWithFormat:@"%d",(numBeishu-10)*10+10];
//    }else if (numBeishu>19 && numBeishu<=28)
//    {
//        self.fieldBeishu.text = [NSString stringWithFormat:@"%d",(numBeishu-19)*100+10+90];
//    }else if (numBeishu>28 && numBeishu<=37)
//    {
//        self.fieldBeishu.text = [NSString stringWithFormat:@"%d",(numBeishu-28)*1000+10+90+900];
//    }else if (numBeishu>37 && numBeishu<=46)
//    {
//        self.fieldBeishu.text = [NSString stringWithFormat:@"%d",(numBeishu-37)*10000+10+90+900+9000];
//    }
    
    allAmount = 2 * [[RuYiCaiLotDetail sharedObject].zhuShuNum intValue] * (int)([self.fieldBeishu.text floatValue] + 0.5f);
...
- (void)setBatchCodeShow
{
    if ([[RuYiCaiLotDetail sharedObject].lotNo isEqualToString:kLotNoBJDC_RQSPF] ||
        ...
        UILabel* batchCodeLabel = [[UILabel alloc] initWithFrame:CGRectMake(145, 2, 150, 40)];
        batchCodeLabel.text = [NSString stringWithFormat:@"期号：第%@期",[RuYiCaiLotDetail sharedObject].batchCode];
        batchCodeLabel.textColor = [UIColor blackColor];
        batchCodeLabel.font = [UIFont systemFontOfSize:15.0];
        [self.betInfo_downView addSubview:batchCodeLabel];
...
- (void)textFieldDidEndEditing:(UITextField *)textField
{
    ...
    if(textField == self.fieldBeishu)
    {
        ...
        if ([self.fieldBeishu.text intValue]>0 && [self.fieldBeishu.text intValue]<=10)
        {
            self.sliderBeishu.value = [self.fieldBeishu.text intValue];
        }else if([self.fieldBeishu.text intValue]>10 && [self.fieldBeishu.text intValue]<=100)
        {
            self.sliderBeishu.value = ([self.fieldBeishu.text intValue]-10)/10+10;
        }else if ([self.fieldBeishu.text intValue]>100 && [self.fieldBeishu.text intValue]<=1000)
        {
            self.sliderBeishu.value = ([self.fieldBeishu.text intValue]-19)/100+19;
        }else if ([self.fieldBeishu.text intValue]>1000 && [self.fieldBeishu.text intValue]<=10000)
        {
            self.sliderBeishu.value = ([self.fieldBeishu.text intValue]-28)/1000+28;
        }else if ([self.fieldBeishu.text intValue]>10000 && [self.fieldBeishu.text intValue]<=100000)
        {
            self.sliderBeishu.value = ([self.fieldBeishu.text intValue]-37)/10000+37;
        }
...
-(UIScrollView*) creatExpandCellView
{
    ...
    UIScrollView* view = [[[UIScrollView alloc] initWithFrame:CGRectMake(10, 134, 300, kMoveDownHeight)] autorelease];
                ...
                for (int j = 0 ; j < [array_3 count];j++) {
                    ...
                    if ([str_3 length] > 0) {
                        ...
                        if ([playChoose length] > 0) {
                            ...
                            UILabel* lable = [[[UILabel alloc] initWithFrame:CGRectMake(10, heightindex * 19 , 60, 19)] autorelease];
                            lable.textColor = [UIColor blackColor];
                            lable.backgroundColor = [UIColor clearColor];
                            lable.font = [UIFont systemFontOfSize:13];
                            lable.textAlignment = UITextAlignmentLeft;
                        ...
                        if ([play_content length] > 0)
                        {
                            ...
                            /*0:2 0:3 1:0 2: 0 3:0 5:2
                             胜其他 平其他 负其他
                             */
                            UILabel* lable_content = [[[UILabel alloc] initWithFrame:CGRectMake(70, 19 * heightindex, 300 - 80, hangnum * 19)] autorelease];
