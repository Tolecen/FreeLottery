...
#import "JC_LQLeagueTableCell.h"
#import "CheckButton.h"
#import "JC_PlayChooseViewContoller.h"
@interface JC_LQLeagueTableCell (internal)

@end
@implementation JC_LQLeagueTableCell
...
-(void) buttonClick:(NSInteger) tag SELECT:(BOOL)isSelect
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"selectButtonNSNottifi" object:nil];
}
- (void)dealloc
{
