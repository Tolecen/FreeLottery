//
//  X115_PickNumberViewController.h
//  RuYiCai
//
...
@interface X115_PickNumberViewController : UIViewController <RandomPickerDelegate, UIAlertViewDelegate,CustomSegmentedControlDelegate>{
