////
////  X11YDJ_PickNumberViewController.m
////  RuYiCai
////
...
@interface X11YDJ_PickNumberViewController (internal)
...
- (NSString*)appendBetCodeTagCode:(NSString*)betCodeTagCode;
...
@implementation X11YDJ_PickNumberViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [[RuYiCaiNetworkManager sharedManager]highFrequencyInquiry:kLotNo11YDJ];
...
- (void)viewDidLoad
{
    ...
    self.scrollDirect.frame = CGRectMake(0, 60, 320, [UIScreen mainScreen].bounds.size.height - 240);
    self.scrollDrag.frame = CGRectMake(0, 60, 320, [UIScreen mainScreen].bounds.size.height - 240);
...
- (void)newThreadRun
{
    ...
    [[RuYiCaiNetworkManager sharedManager] getLotMissdateWithLotno:kLotNo11YDJ sellWay:@"T01012MV_RX"];
...
- (void)queryBetLotButtonClick:(id)sender
{
    ...
    [CommonRecordStatus commonRecordStatusManager].QueryBetlotNO = kLotNo11YDJ;
...
- (void)luckButtonClick:(id)sender
{
    ...
    //    十一运夺金
    //    广东快乐十分
    [pickNumberView randomPickerView:m_delegate.randomPickerView selectRowNum:6];
...
- (void)setupQueryLotBetViewController
{
    ...
    [viewController setSelectLotNo:kLotNo11YDJ];
...
- (void)setupSubViewsOfDirectGroup
{
	...
	CGRect frameRedBall100 = CGRectMake((320 - (8 * kBallVerticalSpacing) - 9 * kBallRectWidth) / 2,
                                        ...
                                        9 * (kBallRectWidth + kBallVerticalSpacing),
                                        (kBallRectHeight + kBallLineSpacing) * 5);
...
- (void)updateSubViewsOfDirect
{
    ...
    NSArray* arrayMonney = kwinMonneyArray_direct;
    m_winDescribtionLable.text = [arrayDes objectAtIndex:m_playType];
    m_winMonneyLable.text = [arrayMonney objectAtIndex:m_playType];
...
- (void)updateSubViewsOfDrag
{
    ...
    NSArray* array = kwinDescribtionArray_dantuo;
    NSArray* array_win = kwinMonneyArray_dantuo;
    m_winDescribtionLable_dan.text = [array objectAtIndex:drag_PlayType];
    m_winMonneyLable_dan.text = [array_win objectAtIndex:drag_PlayType];
...
- (NSString*)appendBetCodeTagCode:(NSString*)betCodeTagCode
{
    if(kSegmentedDrag == self.segmentedView.segmentedIndex)
    {
        switch (drag_PlayType)
        {
            case kPlayType2:
                betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"121@"];
                break;
            case kPlayType3:
                betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"122@"];
                break;
            case kPlayType4:
                betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"123@"];
                break;
            case kPlayType5:
                betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"124@"];
                break;
            case kPlayType6:
                betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"125@"];
                break;
            case kPlayType7:
                betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"126@"];
                break;
            case 6:
                betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"133@"];
                break;
            case 7:
                betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"153@"];
                break;
            default:
                break;
        }
    ...
    else
    {
        switch (m_playType)
        {
            case kPlayType1:
            {
                betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"101@*"];
                break;
            }
            case kPlayType2:
            {
                if (kSegmentedDirect == self.segmentedView.segmentedIndex && m_numZhu > 1)
                    betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"102@*"];
                else
                    betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"111@"];
                break;
            }
            case kPlayType3:
            {
                if (kSegmentedDirect == self.segmentedView.segmentedIndex && m_numZhu > 1)
                    betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"103@*"];
                else
                    betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"112@"];
                break;
            }
            case kPlayType4:
            {
                if (kSegmentedDirect == self.segmentedView.segmentedIndex && m_numZhu > 1)
                    betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"104@*"];
                else
                    betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"113@"];
                break;
            }
            ...
            {
                if (kSegmentedDirect == self.segmentedView.segmentedIndex && m_numZhu > 1)
                    betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"105@*"];
                else
                    betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"114@"];
                break;
            }
            ...
            {
                if (kSegmentedDirect == self.segmentedView.segmentedIndex && m_numZhu > 1)
                    betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"106@*"];
                else
                    betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"115@"];
                break;
            }
            ...
            {
                if (kSegmentedDirect == self.segmentedView.segmentedIndex && m_numZhu > 1)
                    betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"107@*"];
                else
                    betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"116@"];
                break;
            }
                
            case kPlayType8:
            {
                betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"117@"];
                break;
            }
            case kPlayTypezu2:
            {
                if (kSegmentedDirect == self.segmentedView.segmentedIndex && m_numZhu > 1)
                {
                    betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"108@*"];
                }
                else
                    betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"131@"];
                break;
            }
            case kPlayTypezhi2:
            {
                //                //只有单式
                //                betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"141@"];
                //                break;
                if (kSegmentedDirect == self.segmentedView.segmentedIndex && m_numZhu > 1)
                {
                    betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"142@"];
                }
                else
                    betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"141@"];
                break;
            ...
            case kPlayTypezu3:
            {
                if (kSegmentedDirect == self.segmentedView.segmentedIndex && m_numZhu > 1)
                {
                    betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"109@*"];
                }
                else
                    betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"151@"];
                break;
            }
            case kPlayTypezhi3:
            {
                //                //目前只支持单式投注
                //                betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"161@"];
                //                break;
                if (kSegmentedDirect == self.segmentedView.segmentedIndex && m_numZhu > 1)
                {
                    betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"162@"];
                }
                else
                    betCodeTagCode = [betCodeTagCode stringByAppendingFormat:@"161@"];
                break;
...
- (void)submitLotNotification:(NSNotification*)notification
{
    ...
    if (kSegmentedDirect == self.segmentedView.segmentedIndex)
    {
        NSArray *redBalls = [self.ballViewDirect selectedBallsArray];
		int nRedCount = [redBalls count];
		NSArray *qianBalls = [self.ballViewDirect1000 selectedBallsArray];
		int nQianCount = [qianBalls count];
		NSArray *baiBalls = [self.ballViewDirect100 selectedBallsArray];
        int nBaiCount = [baiBalls count];
        
        betCode = [self appendBetCodeTagCode:betCode];
        switch (m_playType)//只有一注含相同号码时：03*0304*0405
        {
            case kPlayTypezhi2:
                if(m_numZhu == 1 && (nRedCount > 1 || nQianCount > 1))
                    betCode = @"142@";
                break;
            case kPlayTypezhi3:
                if(m_numZhu == 1 && (nRedCount > 1 || nQianCount > 1 || nBaiCount > 1))
                    betCode = @"162@";
                break;
            default:
                break;
...
//                    betCode = [betCode stringByAppendingFormat:@"%@", @"*"];
    ...
    NSLog(@"betCode %@", [RuYiCaiLotDetail sharedObject].betCode);
...
- (void)getMissDateNet
{
    if(kSegmentedDirect == self.segmentedView.segmentedIndex)
    {
        if (m_playType == kPlayTypezhi2 || m_playType == kPlayTypezhi3 || m_playType == kPlayType1)
        {
            ...
            {
                [RuYiCaiNetworkManager sharedManager].netLotType = NET_LOT_MISSDATE;
                [[RuYiCaiNetworkManager sharedManager] getLotMissdateWithLotno:kLotNo11YDJ sellWay:@"T01012MV_Q3"];
            }
            else
            {
                [self refreshMissView];
        ...
        else if (m_playType == kPlayTypezu2)
        {
            ...
            {
                [RuYiCaiNetworkManager sharedManager].netLotType = NET_LOT_MISSDATE;
                [[RuYiCaiNetworkManager sharedManager] getLotMissdateWithLotno:kLotNo11YDJ sellWay:@"T01012MV_Q2Z"];
            }
            else
            {
                [self refreshMissView];
        ...
        else if(m_playType == kPlayTypezu3)
        {
            ...
            {
                [RuYiCaiNetworkManager sharedManager].netLotType = NET_LOT_MISSDATE;
                [[RuYiCaiNetworkManager sharedManager] getLotMissdateWithLotno:kLotNo11YDJ sellWay:@"T01012MV_Q3Z"];
            }
            else
            {
                [self refreshMissView];
...
- (void)detailViewButtonClick:(id)sender
{
    ...
    else
    {
        ...
        //        [UIView setAnimationCurve:UIViewAnimationCurveEaseIn];//设置动画块中的动画属性变化的曲线，此方法必须在beginAnimations方法和
        // [UIView setAnimationTransition:UIViewAnimationTransitionCurlUp forView:m_detailView cache:YES];
...
- (void)refreshLeftTime
{
	...
	else if(leftTime == 0)//防止过期彩种
	{
		...
		[[RuYiCaiNetworkManager sharedManager] showMessage:[NSString stringWithFormat:@"十一运夺金%@期时间已到，进入下一期" , self.batchCode] withTitle:@"提示" buttonTitle:@"确定"];
