//
//  GZ11X5_PickNumberViewController.h
//  RuYiCai
//
...
@interface GZ11X5_PickNumberViewController : UIViewController<RandomPickerDelegate, UIAlertViewDelegate,CustomSegmentedControlDelegate>{
