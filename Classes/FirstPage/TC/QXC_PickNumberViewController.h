//
//  QXC_PickNumberViewController.h
//  RuYiCai
//
...
@interface QXC_PickNumberViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, RandomPickerDelegate,UIAlertViewDelegate,CustomSegmentedControlDelegate>
{
//    UIButton*                  m_backButton;
	...
	PickBallViewController     *m_ballView100000;
	PickBallViewController     *m_ballView1000000;
...
@property(nonatomic, retain)PickBallViewController        *ballView100000;
@property(nonatomic, retain)PickBallViewController        *ballView1000000;
